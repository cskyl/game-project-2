...
export const ACTIONS: Action[] = [
  {
    ...
    description: {
      en: "Steady, low-cost studying. Knowledge up, a little stress.",
      zh: "稳扎稳打地学习。知识增加，压力略升。",
    },
    flavor: {
    ...
    cost: 1,
    effects: { knowledge: 5, stress: 3, mood: -1 },
    tags: ["study"],
  },
  {
    id: "deep_study",
    ...
    cost: 2,
    effects: { knowledge: 11, stress: 8, stamina: -4, mood: -3 },
    tags: ["study", "heavy"],
  },
  {
    id: "sim_lab",
    ...
    cost: 2,
    effects: { handSkill: 9, stress: 5, stamina: -5, confidence: 1 },
    tags: ["lab", "heavy"],
  },
  {
    id: "quick_drill",
    ...
    description: {
      en: "A short drill. Small hand skill gain, light cost.",
      zh: "短时训练。手感小幅提升，消耗较低。",
    },
    cost: 1,
    effects: { handSkill: 4, stress: 2, stamina: -2 },
    tags: ["lab"],
  },
  {
    id: "clinic_prep",
    ...
    cost: 2,
    effects: { clinicalSense: 7, confidence: 3, stress: 5, empathy: 2 },
    tags: ["clinic", "heavy"],
  ...
  },
  {
    ...
    description: {
      en: "Practice talking with patients. Empathy and confidence up.",
      zh: "练习与患者沟通。同理心和自信提升。",
    },
    cost: 1,
    effects: { empathy: 5, confidence: 2, reputation: 1 },
    tags: ["clinic", "social"],
    unlock: { minSemester: 4 },
  },
  {
  ...
  },
  {
    ...
    cost: 2,
    effects: { publicImpact: 8, empathy: 5, reputation: 2, stamina: -4 },
  ...
  },
  {
    ...
    cost: 2,
    effects: { research: 8, knowledge: 2, reputation: 2, stress: 4, mood: -2 },
    tags: ["study", "heavy"],
  },
  {
    id: "work",
  ...
  },
  {
    ...
    description: {
      en: "Get help on your weakest skill. Balanced growth, a little reputation.",
      zh: "在最弱的能力上求助。均衡成长，口碑略升。",
    },
    flavor: {
