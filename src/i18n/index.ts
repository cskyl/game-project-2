...
const en = {
  ...
  caseOutcome: {
    excellent: "It went well",
    good: "Solid work",
    rough: "A rough one",
    bad: "This one stays with you",
  },
  caseRoll: {
    skill: "Your skill in this case",
    decisions: "Your decisions",
    difficulty: "Case difficulty",
    modifier: "Support and equipment",
    chance: "Chance",
    total: "Total",
  },
  ...
  // Sim lab (P4)
  simLab: "Sim Lab",
  simLabApproach: { fast: "Fast", careful: "Careful", textbook: "By the book" },
  simLabApproachHint: {
    fast: "Quicker and less draining. Tends to over-prepare.",
    careful: "Balanced. Costs stamina.",
    textbook: "Most precise. Slow, tiring, and tends to be timid.",
  },
  simLabStageOutcome: { over: "Over-prepared", ideal: "Ideal", under: "Under-prepared" },
  simLabResult: {
    commendation: "Faculty commendation",
    pass: "Signed off",
    rough: "Re-do",
  },
  simLabIdealBand: "Ideal is within 4 points of zero, either way.",
...
const zh: typeof en = {
  ...
  howComputed: "这是怎么算出来的？",
  simLab: "Sim Lab",
  simLabApproach: { fast: "求快", careful: "稳妥", textbook: "照本宣科" },
  simLabApproachHint: {
    fast: "更快、更省力。容易预备过量。",
    careful: "折中。消耗体力。",
    textbook: "最精确。慢、累，而且容易过于保守。",
  },
  simLabStageOutcome: { over: "预备过量", ideal: "恰到好处", under: "预备不足" },
  simLabResult: {
    commendation: "获得老师嘉奖",
    pass: "通过签字",
    rough: "需要重做",
  },
  simLabIdealBand: "误差在正负 4 以内即为“恰到好处”。",
  randomEvent: "本周遭遇",
